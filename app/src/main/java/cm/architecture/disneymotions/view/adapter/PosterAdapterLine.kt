...
class PosterAdapterLine: BaseAdapter() {
    ...
    override fun layout(sectionRow: SectionRow): Int = R.layout.item_poster_line

    override fun viewHolder(layout: Int, view: View): BaseViewHolder = PosterLineViewHolder(view)
